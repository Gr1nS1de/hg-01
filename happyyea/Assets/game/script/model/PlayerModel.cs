...
public class PlayerModel : Model
{
	...
	public float 						jumpWidth				{ get { return _jumpWidth 				= game.model.roadModel.width / 2f - currentSprite.bounds.size.x * 0.5f * game.view.playerSpriteView.transform.localScale.x; } }
