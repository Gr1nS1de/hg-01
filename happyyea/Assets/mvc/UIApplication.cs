...
{
	public UIModel			model				{ get { return _model 			= SearchLocal<UIModel>(_model); } }
	public UIView			view				{ get { return _view			= SearchLocal<UIView>(_view); } }
	public UIController		controller			{ get { return _controller		= SearchLocal<UIController>(_controller); } }
